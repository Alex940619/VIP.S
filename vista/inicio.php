...
<div class="menu">
	...
	<a href="Tabla_Produccion.php" class="d-block p-3 text-dark font-weight-bold" target="principal"><ion-icon name="clipboard"></ion-icon> Produccion</a><hr>

	<a href="Tabla_Materia.php" class="d-block p-3 text-dark font-weight-bold" target="principal"><ion-icon name="clipboard"></ion-icon> Materia Prima</a><hr>
	...
	<a href="" class="d-block p-3 text-dark font-weight-bold" target="principal"> Pedidos</a><hr>
	...
	<a href="" class="d-block p-3 text-dark font-weight-bold" target="principal"> </a><hr>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item text-danger" href="index.php">Cerrar sesion</a>
        </div>
      </li>
