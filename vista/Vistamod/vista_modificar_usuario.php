...
$doc_usuario = $_REQUEST['doc'];
$us = new usuario();
if ($resultado=$us->buscar('usuario',$doc_usuario))
{
...
<html lang="es">
  <head>
    ...
    <title>SIGA: modificar usuario</title>
	...
	<div class="container">
		...
		<div class="login-form">
			...
			<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-register" role="form" id="register-form">
				...
				<button class="btn btn-block bt-login" type="submit" id="submit_btn" data-loading-text="Agregar....">Modificar usuario</button>
                <?php 
                 if ($errores)
                { 
                ?>
